...
NSMAP = {'marc': 'http://www.loc.gov/MARC21/slim'} # This is the MARC21 namespace used in the file pgmarc.xml from Project Gutenberg.
...
def validateAndExtractRecords(xmlPath, xsdPath, outputPath):
    ...
    # Write the filtered output to the file specified by outputPath
